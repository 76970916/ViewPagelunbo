package demo.mytest.com.viewpagelunbo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void initData() {
        ...
        int[] imageRess = new int[]{R.drawable.img1,R.drawable.img1,R.drawable.img2,R.drawable.img3};
    ...
    public void initView(){
        ViewPageAdapter viewPagerAdapter = new ViewPageAdapter(mImageList, mViewPager);
